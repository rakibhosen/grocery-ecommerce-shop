		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-8 header">
				...
				@php
					$user = Auth::user();
				@endphp
					<img src="{{ asset('upload/user/'.$user->avatar) }}" alt="" width="40px" width="40px" style="border-radius:50%">
				
				     <a class="dropdown-toggle" data-toggle="dropdown" >{{$user->name}}
        <span class="caret"></span></a>
        <ul class="dropdown-menu"  style="text-align:center;">
      
        
       <a href="{{route('user.dashboard')}}">Profile</a><br>
	   <hr>
				...
				<!-- //header lists -->
				<!-- search -->
@include('frontend.partials.productSearch')
				<!-- //search -->
				<!-- cart details -->
				...
				<div class="top_nav_right">
					<div class="wthreecartaits wthreecartaits2 cart cart box_1">
							...
							<a href="{{ route('cart.index') }}" class="w3view-cart">

							
									@if (Auth::user())
									<span class="badge" id="total_item">
